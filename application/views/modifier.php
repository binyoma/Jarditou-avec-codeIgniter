...
<div class="form-group">
    ...
    <input class="form-control" type="text"  name="pro_description" value="<?php echo set_value('pro_description',$produit->pro_description); ?>">
    <?php echo form_error('pro_description'); ?>
</div>
<div class="form-group">
    <label for="pro_prix"> Prix</label>
    <input class="form-control" type="decimal"  name="pro_prix" value="<?php echo set_value('pro_prix',$produit->pro_prix); ?>">
    <?php echo form_error('pro_prix'); ?>
</div>
<div class="form-group">
    <label for="pro_stock"> Stock</label>
    <input class="form-control" type="number"  name="pro_stock" value="<?php echo set_value('pro_stock',$produit->pro_stock); ?>">
    <?php echo form_error('pro_stock'); ?>
</div>
<div class="form-group">
    <label for="pro_couleur"> Couleur</label>
    <input class="form-control" type="text"  name="pro_couleur" value="<?php echo set_value('pro_couleur',$produit->pro_couleur); ?>">
